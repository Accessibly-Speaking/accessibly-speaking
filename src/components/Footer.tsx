        ...
        <div className="grid md:grid-cols-2 gap-10 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:accessiblyspeaking@gmail.com" aria-label="Email" className="p-2 bg-white text-black rounded-full hover:bg-gray-200 transition-colors">
          ...
          <div>
            ...
            <div className="flex">
              <Input 
                ...
                className="rounded-r-none border-white/20 bg-white/10 text-white placeholder:text-gray-400 focus:border-white hover:border-white/30"
              />
              <Button 
